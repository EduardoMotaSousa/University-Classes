...
O site utiliza a API do GitHub juntamente com um sistema de árvore do repositório para reduzir requisições e melhorar desempenho.
...
✔ Visualizador de código integrado
